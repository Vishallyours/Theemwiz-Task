...
function PricingSection() {
    ...
    return (
        <div className='bg-[#FDF0E9] w-full h-auto justify-between font-epilogue px-4 md:px-36 md:py-24 '>
    ...
    <span className='flex font-extrabold leading-none md:text-6xl text-4xl '>Check Our <br/>
Pricing Plans</span>
    </div>

</div>
<div className='flex h-96 mt-56 justify-center items-end gap-4'>
